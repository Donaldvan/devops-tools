                ...
                <div id="owl-testimonials" class="owl-carousel owl-theme">
                    <div class="item">
                        ...
                        <p>Instructor has a good hold on the subject and has lot of patience to take all possible questions from 
                            <span class="extra-reading">the participant. Appreciate all the analogies presented to explain the subject in a laymanÃ¢â‚¬&trade;s language. It became really easy to correlate and make you remember and relate to the concept in a very easy way.</span>
     ...
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding border-top-half">
      <div class="padding-vr20 clearfix padding-btm-50-query pad-btm-none">
       ...
       <div class="col-lg-7 col-md-6 col-sm-7 col-xs-12 no-padding txt-marg-top text-xs-left">
        <p class="grey-txt">"PMPÂ®","PMIÂ®", "PMI-ACPÂ®" and "PMBOKÂ®" are registered marks of the Project Management Institute, Inc. <br>
MongoDBÂ®, Mongo and the leaf logo are the registered trademarks of MongoDB, Inc.</p>
       </div>
      </div>
     </div>
     </div>
